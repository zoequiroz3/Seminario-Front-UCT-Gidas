...
export default function ParticipacionesForm() {
  ...
  const validate = () => {
    ...
    if (!investigadorId) newErrors.investigador = "Debe seleccionar investigador";
    if (!nombreEvento.trim()) newErrors.nombreEvento = "Debe ingresar nombre del evento";
    if (!formaParticipacion) newErrors.formaParticipacion = "Debe seleccionar forma de participación";
  ...
  if (isEdit && isLoading) return <p>Cargando participación…</p>;
    ...
    <section className="w-full">
      ...
      >
        <Field label="Investigador">
          ...
          >
            <option value="" disabled>Seleccionar investigador</option>
          ...
          {errors.investigador && <p className="text-red-500 text-sm mt-1">{errors.investigador}</p>}
        </Field>
        ...
        <Field label="Nombre del evento">
          ...
          />
          {errors.nombreEvento && <p className="text-red-500 text-sm mt-1">{errors.nombreEvento}</p>}
        </Field>
        ...
        <Field label="Forma de participación">
          ...
          {errors.formaParticipacion && <p className="text-red-500 text-sm mt-1">{errors.formaParticipacion}</p>}
        </Field>
